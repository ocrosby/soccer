// Package classification tds-coaching-change-service
//
// This service provides a RESTful API for accessing Division I coaching changes from TopDrawerSoccer.com.
//
//	Schemes: http, https
//	BasePath: /
//	Version: 1.0.0
...
import (
	"context"
	"fmt"
	service "github.com/ocrosby/soccer/internal/tds-coaching-change-service"
	"io"
	"log"
	"net/http"
	"os"
